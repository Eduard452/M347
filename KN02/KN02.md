...
## 6. Zusammenfassung der Schritte

| Schritt              | Befehl oder Aktion                                                 |
| -------------------- | ------------------------------------------------------------------ |
| Dockerfile erstellen | Siehe angepasster Inhalt oben                                      |
| Image bauen          | `docker build -t eduard1233/m347:kn02a .`                        |
| Image pushen         | `docker push eduard1233/m347:kn02a`                              |
| Container starten    | `docker run -d -p 8082:80 --name my-kn02a eduard1233/m347:kn02a` |
| Webseite aufrufen    | `http://localhost:8082`                            |
...
## 4. Zusammenfassung aller Docker-Befehle

| Aufgabe                   | Befehl                                                                                      |
| ------------------------- | ------------------------------------------------------------------------------------------- |
| Netzwerk erstellen        | `docker network create kn02b-net`                                                           |
| Build MariaDB Image       | `docker build -t eduard1233/m347:kn02b-db .`                                              |
| Push MariaDB Image        | `docker push eduard1233/m347:kn02b-db`                                                    |
| Start MariaDB Container   | `docker run -d --name kn02b-db --network kn02b-net eduard1233/m347:kn02b-db`              |
| Build Webserver Image     | `docker build -t eduard1233/m347:kn02b-web .`                                             |
| Push Webserver Image      | `docker push eduard1233/m347:kn02b-web`                                                   |
| Start Webserver Container | `docker run -d --name kn02b-web -p 8083:80 --network kn02b-net eduard1233/m347:kn02b-web` |
